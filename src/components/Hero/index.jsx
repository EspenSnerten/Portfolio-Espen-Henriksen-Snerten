...
export default function Hero() {
  return (
    <>
      <Fade>
        <section className="flex flex-col w-full min-h-screen px-2">
          <div className="max-w-[1366px] w-full flex flex-col gap-12  m-auto py-7">
            <div className="flex flex-col w-full">
              ...
              <h1 className="text-3xl tracking-wide text-white md:text-4xl hero-text">
                Hi, I'm <span className="text-4xl md:text-5xl ">Snerten</span>, a Frontend Developer transforming{" "}
              </h1>
              </Fade>
              <Fade direction="right">
              <h2 className="text-2xl tracking-wide text-white md:text-4xl hero-text">Ideas into Web Realities</h2>
              </Fade>
            ...
            <div className="flex gap-6 align-middle">
              <a href="">
                <FontAwesomeIcon icon={faLinkedin} className="text-white text-[24px] my-auto align-middle" />
              </a>
              <a href="">
                <FontAwesomeIcon icon={faGithub} className="text-white text-[24px] my-auto align-middle" />
              </a>
              <a href="" className="my-auto">
                <img src={MailIcon} alt="" className="my-auto w-[29px] my-autp h-auto align-middle" />
              </a>
            </div>
          </div>
        </section>
