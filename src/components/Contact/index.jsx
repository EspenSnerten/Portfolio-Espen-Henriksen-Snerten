  ...
  return (
    <>
      <Fade className="w-full px-2">
        <section
          id="contact"
          className="flex flex-col w-full min-h-screen max-w-[1366px] mx-auto"
        >
          <div className="flex flex-col my-auto">
            <div className="mb-11 w-fit">
              ...
              <p className="text-[21px] max-w-[365px] w-full text-white">
                Feel free to contact me! I'm open to collaboration and would
                love to hear your ideas for new websites. I will get back to you
                as soon as possible.
              </p>
            </div>
            <form action="">
